...
class poseDetector():
    ...
    def __init__(self , mode = False , complexity = 1 , landmarks = True ,
        enableseg = False , smoothseg = True , detectionCon = 0.5 , trackingCon = 0.5):
        ...
        self.pose = self.mpPose.Pose(self.mode , self.complexity , self.landmarks ,
                    self.enableseg , self.smoothseg , self.detectionCon , self.trackingCon)
    ...
    def findAngle(self , img , p1 , p2 , p3 , draw = True):
        # Get landmarks
        x1 , y1 = self.lmList[p1][1:] # or _ , x1 , y1 = self.lmList[p1] _ ignore the first one
